...
const DesktopNavbar = (props) => { 
    ...
    // Contact link
    const contactLink = <Link style={{color: props.linkColor  }} className={`nav-link`} to="/contact" onClick={() => props.setNavColor("black")}>CONTACT</Link>;
    // faBars fontawesome
            ...
            <div className="collapse navbar-collapse d-flex justify-content-between" id="navbarSupportedContent">
                <ul className="navbar-nav">
                   <li className="nav-item">
                        <Link to="/" onClick={() => props.setNavColor("white")}>
                ...
                <ul className="navbar-nav desktopNav">
                    <li className="nav-item">
                    <Link style={{color: props.linkColor }} className="nav-link" to="/models" onClick={() => props.setNavColor("white")}>MODEL S</Link>
                    </li>
                    <li className="nav-item">
                    <Link style={{color: props.linkColor }} className="nav-link" to="/model3" onClick={() => props.setNavColor("white")}>MODEL 3</Link>
                    </li>
                    <li className="nav-item">
                    <Link style={{color: props.linkColor }} className="nav-link" to="/modelx" onClick={() => props.setNavColor("white")}>MODEL X</Link>
                    </li>
                    <li className="nav-item">
                    <Link style={{color: props.linkColor }} className="nav-link" to="/modely" onClick={() => props.setNavColor("white")}>MODEL Y</Link>
                    </li>
                    <li className="nav-item">
                    <Link style={{color: props.linkColor }} className="nav-link" to="/cybertruk" onClick={() => props.setNavColor("white")}>CYBERTRUCK</Link>
                    </li>
                    <li className="nav-item" >
                    <Link style={{color: props.linkColor }} className="nav-link" to="/roadster" onClick={() => props.setNavColor("black")}>ROADSTER</Link>
                    </li>
                    <li className="nav-item">
                    <Link style={{color: props.linkColor }} className="nav-link" to="/energy" onClick={() => props.setNavColor("white")}>ENERGY</Link>
                    </li>
                </ul>
                <ul className="navbar-nav">
                    <li className="nav-item">
